var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1NotificationLogController'),
...
describe('V1NotificationLog Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1notificationlog'] = _.cloneDeep(stubs.genericModel);
    values = {"id":"Communicative redistributed","message":"Existentialists penitence","notificationType":"Hinging superintendency","sentAt":"2014-06-10","userName":"Rubbers ungainliest"};

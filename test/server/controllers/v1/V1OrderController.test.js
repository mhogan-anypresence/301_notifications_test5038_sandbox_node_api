var assert      = require('assert'),
    ...
    stubs       = require('../../stubs'),
    controller  = rewire('../../../../api/controllers/V1OrderController'),
...
describe('V1Order Controller', function() {
  ...
  beforeEach(function() {
    ...
    // Refresh model
    model = stubs.sails.models['v1order'] = _.cloneDeep(stubs.genericModel);
    values = {"id":"Parenthesizing collaborations","desc":"Phishing Baroda","name":"Boyce Parisian"};

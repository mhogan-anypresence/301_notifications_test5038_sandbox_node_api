...
var V1NotificationLogController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1NotificationLogController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1notificationlog'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1NotificationLogController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1NotificationLogController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1NotificationLogController.create");
...
if(extensions) {
  extend(V1NotificationLogController, 'V1NotificationLogController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1NotificationLogController, 'V1NotificationLogController', callbacks, 'callbacks');
}

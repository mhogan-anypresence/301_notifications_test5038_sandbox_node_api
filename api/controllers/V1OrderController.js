...
var V1OrderController = module.exports = {
  find: function(req, res) {
    sails.log.debug("V1OrderController.find");
    var results, model, dataProxy, scope;

    model = sails.models['v1order'];
  ...
  destroy: function(req, res) {
    sails.log.debug("V1OrderController.destroy");
  ...
  update: function(req, res) {
    sails.log.debug("V1OrderController.update");
  ...
  create: function(req, res) {
    sails.log.debug("V1OrderController.create");
...
if(extensions) {
  extend(V1OrderController, 'V1OrderController', extensions, 'customCode');
}

if (callbacks) {
  extend(V1OrderController, 'V1OrderController', callbacks, 'callbacks');
}
